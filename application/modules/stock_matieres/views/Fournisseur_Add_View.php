    ...
    <div class="content-wrapper">
      ...
      <div class="page-content fade-in-up">
        <div class="ibox">
          ...
          ?>
          <div class="ibox-body">
            <form id="FormData" action="<?php echo base_url()?>stock_matieres/Fournisseur/add" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6 form-group">
                  ...
                  <input class="form-control" type="email" class="form-control" id="EMAIL" name="EMAIL" placeholder="username@superbat.bi" value="<?=set_value('EMAIL')?>">
                  <?php echo form_error('EMAIL', '<div class="text-danger">', '</div>'); ?>
                </div>
                <div class="col-sm-6 form-group">
                  <label>Telephone<span class="text-danger">*</span></label>
                  <input class="form-control" type="text" id="TELEPHONE" name="TELEPHONE" placeholder="T&eacute;l&eacute;phone" value="<?=set_value('TELEPHONE')?>">
                  <?php echo form_error('TELEPHONE', '<div class="text-danger">', '</div>'); ?>
                </div>

                <div class="col-sm-6 form-group">
                  <label>Localite <span class="text-danger">*</span></label>
                  <input class="form-control" type="text" id="LOCALITE" name="LOCALITE" placeholder="Localit&eacute;" value="<?=set_value('LOCALITE')?>">
