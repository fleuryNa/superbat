                ...
                <div class="ibox">
                    <div class="ibox-body">
                     <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link active" href="#tab-1-1" data-toggle="tab"><i class="fa fa-line-chart"></i> Réception matières premières internqtionales</a>
                    </li>
                    <!-- <li class="nav-item">
...
<script>
    ...
    function initDataTable() {
       var url = "<?= base_url() ?>stock_matieres/Stock_Matieres_New/liste_affiche";
