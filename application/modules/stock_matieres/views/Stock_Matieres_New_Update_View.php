      ...
      <div class="page-content fade-in-up">
        <div class="ibox">
          ...
          <div class="ibox-body">
            ...
            if (!empty($data2)) {
            $QUANTITE=$data2['QUANTITE_RECUE'];
            $DATE_ENTREE=$data2['DATE_ENTREE'];
            $ID_HISTO=$data2['ID_HISTO_STOCK_MATIERE'];
            ...
            <form id="FormData" action="<?php echo base_url()?>stock_matieres/Stock_Matieres_New/update" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <input class="form-control" type="hidden" id="ID_HISTO_STOCK_MATIERE" name="ID_HISTO_STOCK_MATIERE"  value="<?=$ID_HISTO?>">
             ...
             <!--   <div class="col-sm-6 form-group">
              ...
              <!--    <div class="col-sm-6 form-group">
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <input class="form-control" type="text" class="form-control" id="QUANTITE" name="QUANTITE" placeholder="Entrez la quantité" value="<?=set_value('QUANTITE',$QUANTITE)?>">
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <input class="form-control" type="date" id="DATE_ENTREE" name="DATE_ENTREE" value="<?=set_value('DATE_ENTREE',$DATE_ENTREE)?>">
