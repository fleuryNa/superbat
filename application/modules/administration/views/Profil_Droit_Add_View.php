          ...
          <div class="ibox-body">
            <form id="FormData" action="<?php echo base_url()?>administration/Profil_Droit/add" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="DESCRIPTION" name="DESCRIPTION" placeholder="Nom Profil" value="<?=set_value('DESCRIPTION')?>">
                  ...
                  <div class="col-4 m-b-20">
                    <div class="check-list">
                      <label class="ui-checkbox">
                        <input type="checkbox" id="customCheckbox<?php echo $value['ID_DROIT']?>" name="ID_DROIT[]" value="<?php echo $value['ID_DROIT']?>">
