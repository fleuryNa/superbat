            ...
            <form id="FormData" action="<?php echo base_url()?>administration/User/add" method="POST" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <input class="form-control" type="text" id="PRENOM" name="PRENOM" placeholder="Pr&eacute;nom" value="<?=set_value('PRENOM',$data['PRENOM'])?>">
                  <?php echo form_error('PRENOM', '<div class="text-danger">', '</div>'); ?>
                </div>
                <div class="col-sm-6 form-group">
                  <label>E-mail <span class="text-danger">*</span></label>
                  <input class="form-control" type="email" class="form-control" id="USERNAME" name="USERNAME" placeholder="username@superbat.bi" value="<?=set_value('USERNAME',$data['USERNAME'])?>">
                  <?php echo form_error('USERNAME', '<div class="text-danger">', '</div>'); ?>
                </div>
                <div class="col-sm-6 form-group">
                  <label>Password <span class="text-danger">*</span></label>
                  <div class='alert alert-info' >Le mot de passe doit etre change par l'utilisateur</div>
                  <?php echo form_error('PASSWORD', '<div class="text-danger">', '</div>'); ?>
                </div>
                <div class="form-group col-lg-6">
                  <label for="PROFIL_ID">Profile <span class="text-danger">*</span> </label>
                  <select class="form-control input-lg" name="PROFIL_ID" id="PROFIL_ID">
                ...
                <div class="form-group col-lg-6">
                  ...
                  <select class="form-control input-lg" name="ID_AGENCE" id="ID_AGENCE">
                    <option>-- Select --</option>
                    <?php
