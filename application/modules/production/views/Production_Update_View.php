      ...
      <div class="page-content fade-in-up">
        <div class="ibox">
          ...
          <div class="ibox-body">
            ...
            <form id="FormData" action="<?php echo base_url()?>production/Production/update" method="POST" enctype="multipart/form-data">
              <div class="row">
               <input type="hidden" name="ID_PRODUCTION" id="ID_PRODUCTION" value="<?= $data['ID_PRODUCTION'];?>">
               <div class="col-sm-6 form-group">
                ...
                <select class="form-control " id="ID_TYPE_PRODUIT" name="ID_TYPE_PRODUIT" onchange="choixProduit()">
                  <?php if($data['ID_TYPE_PRODUIT']==1){?>
                    <option value="">--select--</option>
                    <option value="1" <?= set_select('ID_TYPE_PRODUIT','1')?> selected>Toles</option>
                    <option value="2" <?= set_select('ID_TYPE_PRODUIT','2')?>>Clous</option>
                  <?php }elseif ($data['ID_TYPE_PRODUIT']==2) { ?>
                    <option value="">--select--</option>
                    <option value="1" <?= set_select('ID_TYPE_PRODUIT','1')?>>Toles</option>
                    <option value="2" <?= set_select('ID_TYPE_PRODUIT','2')?> selected>Clous</option>
                  <?php }else{ ?>
             ...
             <div class="col-sm-6 form-group" id="div_toles" style="display:none;">
              ...
              <select class="form-control select2_demo_1" id="ID_TYPE_TOLES" name="ID_TYPE_TOLES">
                ...
                <?php foreach($type_toles as $type){?>
                 <option value="<?= $type['ID_TYPE_TOLES']?>" <?= set_value('ID_TYPE_TOLES',$data['ID_TYPE_TOLES']) == $type['ID_TYPE_TOLES'] ? 'selected' : '' ?>><?= $type['DESCRIPTION_TOLES']; ?></option>
               <?php }?> 
             </select>
           ...
           <div class="col-sm-6 form-group" id="div_clous" style="display:none;">
            ...
            <select class="form-control select2_demo_1" id="ID_TYPE_CLOUS" name="ID_TYPE_CLOUS">
              ...
              <?php foreach($type_clous as $type){?>
                <option value="<?= $type['ID_TYPE_CLOUS']?>" <?= set_value('ID_TYPE_CLOUS',$data['ID_TYPE_CLOUS']) == $type['ID_TYPE_CLOUS'] ? 'selected' : '' ?>><?= $type['DESCRIPTION']; ?></option>
              <?php }?> 
            </select>
          ...
          <div class="col-sm-6 form-group" id="div_toles_colis" style="display:none;">
            ...
            <input class="form-control" type="text" id="NUMERO_COLIS" name="NUMERO_COLIS" value="<?=set_value('NUMERO_COLIS',$data['NUMERO_COLIS'])?>">
          ...
          <div class="col-sm-6 form-group" id="div_toles_couleur" style="display:none;">
            ...
            <input class="form-control" type="text" id="COULEUR" name="COULEUR" value="<?=set_value('COULEUR',$data['COULEUR'])?>">
          ...
          <div class="col-sm-6 form-group" id="div_toles_longueur" style="display:none;">
            ...
            <input class="form-control" type="text" id="LONGUEUR" name="LONGUEUR" value="<?=set_value('LONGUEUR',$data['LONGUEUR'])?>">
          ...
          <div class="col-sm-6 form-group" id="div_toles_bande" style="display:none;">
            ...
            <input class="form-control" type="text" id="NOMBRE_BANDE" name="NOMBRE_BANDE" value="<?=set_value('NOMBRE_BANDE',$data['NOMBRE_BANDE'])?>">
          ...
          <div class="col-sm-6 form-group" id="div_toles_bonet" style="display:none;">
            ...
            <input class="form-control" type="text" id="NOMBRE_BONNET" name="NOMBRE_BONNET" value="<?=set_value('NOMBRE_BONNET',$data['NOMBRE_BONNET'])?>">
          ...
          <div class="col-sm-6 form-group" style="display:none;" id="div_clous_qte">
            ...
            <input class="form-control" type="number" id="QUANTITE" name="QUANTITE" value="<?=set_value('QUANTITE',$data['QUANTITE'])?>">
