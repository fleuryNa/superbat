        ...
        <div class="ibox">
          ...
          <div class="ibox-body">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" href="#tab-1-1" data-toggle="tab"><i class="fa fa-line-chart"></i> Transferer</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#tab-1-2" data-toggle="tab"><i class="fa fa-heartbeat"></i> Receptionner</a>
              </li>
...
<script>
  ...
  function liste_commande() {
    var url = "<?= base_url() ?>production/Transferer/listing";
...
<script>
  ...
  function liste_livre() {
    var url = "<?= base_url() ?>production/Transferer/listing_reception";
    var row_count = "1000000";
