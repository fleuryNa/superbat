            ...
            <div class="page-content fade-in-up">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tabreception"> 
                        <form action="<?= base_url('produit_finis/Produits_Finis/vendre'); ?>" method="POST">
                            ...
                            <table class="table table-striped table-bordered table-hover table-modern" id="mytable" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $cmd['NUMERO_FATURE']; ?></td>
                                        <td><?= $cmd['ID_TYPE_PRODUIT']==1 ? "Toles" : 'Clous' ; ?></td>
                                        <td><?= $cmd['ID_TYPE_PRODUIT']==1 ? $cmd['DESCRIPTION_TOLES'].'('.$cmd['NUMERO_COLIS'].')' : $cmd['DESCRIPTION'] ; ?>

                                             <input type="hidden" name="numerofacture[]" value="<?= $cmd['NUMERO_FATURE']; ?>">
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            style="width:80%;"
                                            class="form-control"
                                            value="<?= $cmd['QUANTITE_VENTE']; ?>"
                                            >

                                        </td>

                                        <!-- ID caché pour récupération -->
                                        <input type="hidden" name="id_vente[]" value="<?= $cmd['ID_VENTE']; ?>">

                                        <!-- Checkbox -->
                                        <td class="text-center">
                                            <label class="ui-checkbox ui-checkbox-primary">
                                                <input type="checkbox" name="select_commande[]" value="<?= $cmd['ID_VENTE']; ?>">
...
<script>
 ...
 function liste_livre() {
    var url = "<?= base_url() ?>produit_finis/Produits_Finis/listing_traite";
